...
bool data_display::set_start_values(st_hit hit)
{
   ...
   cout<<hit.alpha<<endl;
    cout<<hit.alpha_0<<endl;
    cout<<hit.hill_coef<<endl;
    cout<<hit.beta<<endl;

    cout<<hit.mrna_lacI<<endl;
    cout<<hit.mrna_tetR<<endl;
   cout<<hit.mrna_cl<<endl;
    cout<<hit.prot_lacI<<endl;
    cout<<hit.prot_tetR<<endl;
    cout<<hit.prot_cl<<endl;
    ...
    m_alpha=hit.alpha;
    m_alpha_0=hit.alpha_0;
    m_hill_coef=hit.hill_coef;
    m_beta=hit.beta;

    m_curr_mrna_lacI=hit.mrna_lacI;
    m_curr_mrna_tetR=hit.mrna_tetR;
    m_curr_mrna_cl=hit.mrna_cl;
    m_curr_prot_lacI=hit.prot_lacI;
    m_curr_prot_tetR=hit.prot_tetR;
    m_curr_prot_cl=hit.prot_cl;
...
bool data_display::draw(void)
{
    ...
    m_graph_prot_tetR.draw_graph();//reporter
...
bool data_display::generate_data(void)
{
    ...
    for(float t=m_time_start; t<=m_time_end; t+=m_step_size)
    {
        ...
        m_graph_prot_tetR.add_point_without_calc( t,m_curr_prot_tetR );//reporter
