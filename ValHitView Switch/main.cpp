                   ...
                   int nCmdShow)
{
    ...
    {//read values
        ...
        temp_hit.end_time=50;
        temp_hit.step_size=0.1;
        ...
        ss1>>word;//skip title
        ss1>>word;//read value
        temp_hit.start_u=atof( word.c_str() );
        getline(input_file,line);
        stringstream ss2(line);
        ss2>>word;//skip title
        ss2>>word;//read value
        temp_hit.start_v=atof( word.c_str() );
        getline(input_file,line);
        stringstream ss3(line);
        ss3>>word;//skip title
        ss3>>word;//read value
        temp_hit.alpha_u=atof( word.c_str() );
        getline(input_file,line);
        stringstream ss4(line);
        ss4>>word;//skip title
        ss4>>word;//read value
        temp_hit.alpha_v=atof( word.c_str() );
        getline(input_file,line);
        stringstream ss5(line);
        ss5>>word;//skip title
        ss5>>word;//read value
        temp_hit.beta_u=atof( word.c_str() );
        getline(input_file,line);
        stringstream ss6(line);
        ss6>>word;//skip title
        ss6>>word;//read value
        temp_hit.beta_v=atof( word.c_str() );
        getline(input_file,line);
        stringstream ss7(line);
        ss7>>word;//skip title
        ss7>>word;//read value
        temp_hit.iptg_conc_start=atof( word.c_str() );
        getline(input_file,line);
        stringstream ss8(line);
        ss8>>word;//skip title
        ss8>>word;//read value
        temp_hit.iptg_const=atof( word.c_str() );
        getline(input_file,line);
        stringstream ss9(line);
        ss9>>word;//skip title
        ss9>>word;//read value
        temp_hit.iptg_pow=atof( word.c_str() );
